...
class FilterBox extends ProxyBase {
	...
	_openSettingsModal () {
		...
		UiUtil.$getAddModalRowCb($modalInner, "預設反選自製資源", this._meta, "isBrewDefaultHidden");
		...
		$rowResetAlwaysSave.append(`<span>始終在關閉時儲存</span>`);
