...
class PageFilterBestiary extends PageFilter {
	...
	constructor () {
		...
		this._speedTypeFilter = new Filter({header: "Speed Type", headerName: "速度型別", items: ["walk", "burrow", "climb", "fly", "hover", "swim"], displayFn: Parser.SpeedToDisplay});
		...
		this._tagFilter = new Filter({header: "Tag", headerName: "型別副標", displayFn: Parser.MonsterTagToDisplay});
