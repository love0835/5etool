...
class StatGenUi extends BaseComponent {
	...
	_render_$getStgPbCustom () {
		const $btnAddLower = $(`<button class="btn btn-default btn-xs">新增更低的屬性值</button>`)
			.click(() => {
		...
		const $btnAddHigher = $(`<button class="btn btn-default btn-xs">新增更高的屬性值</button>`)
			.click(() => {
			...
			<div class="flex mobile-ish__flex-col w-100 px-3">
				<div class="flex-col">
					...
					<div class="flex">
						...
						<div class="flex-col mr-3">
							<div class="my-1 statgen-pb__header"></div>
							<div class="my-1 statgen-pb__header flex-vh-center help text-muted" title="此處輸入額外/自定義的加值">使用者</div>
							${$wrpsUser}
						</div>
			...
			<div class="flex mobile-ish__flex-col w-100 px-3">
				<div class="flex-col">
					<div class="flex">
						...
						<div class="flex-col mr-3">
							<div class="my-1 bold statgen-pb__header flex-vh-center" title="目前">目前</div>
							${$wrpsExisting}
						</div>
