...
parse_key["headerEntries"] = 0

parse_key["reaction"] = 0
parse_key["bonus"] = 0
parse_key["regionalEffects"] = 0
parse_key["lairActions"] = 0
...
# 指定要掃描的資料夾
folder_path = "./parse_besitary/result"
outpath = "./parse_besitary/translate_result"
